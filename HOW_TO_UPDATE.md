...
Your site lives at: https://shashishekhawat.github.io
...
2. Go to https://github.com/shashishekhawat/shashishekhawat.github.io
...
6. Wait 1-2 minutes, then refresh https://shashishekhawat.github.io to see it live.

## Option B: Update from this computer (using Claude Code or terminal)

The website files are kept in this folder: `~/shashishekhawat.github.io`
...
2. Open a terminal in that folder and run:
   ...
   git push
   ```
3. Wait 1-2 minutes, then refresh https://shashishekhawat.github.io to see it live.

If you're asking Claude Code to do this for you, just say something like: "I have a new index.html in Downloads, please update my website with it" — Claude can copy it into `~/shashishekhawat.github.io` and push it for you.
